...
(setq anki-directory (concat (file-name-as-directory org-roam-directory) "anki"))
...
(setq org-roam-dailies-directory (concat (file-name-as-directory org-roam-directory) "daily"))
(cons 'org-roam-dailies-directory 'org-agenda-files)
#+END_SRC
